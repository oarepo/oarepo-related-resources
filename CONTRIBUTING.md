...
Report bugs at <https://github.com/oarepo/oarepo-related-resources/issues>.
...
<https://github.com/oarepo/oarepo-related-resources/issues>.
...
Ready to contribute? Here's how to set up `oarepo-related-resources` for local
development.

1. Fork the `oarepo/oarepo-related-resources` repo on GitHub.

2. Clone your fork locally:

   ```console
   git clone git@github.com:your_name_here/oarepo-related-resources.git
   ```

3. Install your local copy into a virtual environment:

   ```console
   cd oarepo-related-resources/
   ./run.sh venv
   ```
